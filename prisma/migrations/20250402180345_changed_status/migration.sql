/*
  ...
  - The values [PENDING,COPLETED] on the enum `PdfStatus` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "PdfStatus_new" AS ENUM ('COMPLETED', 'FAILED');
