      ...
      <div className="space-y-4">
        {points.map((point, index) => {
          ...
          return (
            <div
              key={`point-${index}`}
              className="group relative bg-gradient-to-br from-gray-400/[0.03] to-rose-100 p-4 rounded-2xl border border-rose-500/10 shadow-md hover:shadow-lg transition-shadow"
            >
              ...
              <div className="relative flex items-start gap-3">
                ...
                <p className="text-sm sm:text-lg text-muted-foreground leading-relaxed">{text}</p>
              </div>
            </div>
          );
        })}
