...
export default function ChatBox() {
  ...
  const sendMessage = async () => {
    ...
    try {
      ...
      // Add empty bot message BEFORE starting to type

      setMessages((prev) => [...prev, { role: "bot", text: "" }]);

      // Typing effect – update the last message char by char
  ...
  return (
    <div className="flex flex-col max-w-3xl w-full h-[500px] sm:h-[600px] lg:h-[900px] bg-white shadow-lg rounded-2xl overflow-hidden border border-gray-200">
      {/* Chat Window */}
      <div className="flex-1 overflow-y-auto p-4 space-y-4 bg-gray-50">
        ...
        {isLoading && (
          <motion.div
            className="w-fit p-3 rounded-xl bg-gray-200 text-blue-500 text-sm self-start mr-auto"
