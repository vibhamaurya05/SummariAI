...
export function HeroSection() {
  return (
    <section className="relative mx-auto flex flex-col z-0 items-center justify-center py-16 mt-12 sm:py-20 lg:pb-28 transition-all animate-in lg:px-12 max-w-7xl ">
      ...
      <Button size={'lg'} className="rounded-full my-6 shadow-2xl shadow-blue-600"><Link href={'/summaryAI'} className="flex gap-2 items-center" >Try Pdf_summary
